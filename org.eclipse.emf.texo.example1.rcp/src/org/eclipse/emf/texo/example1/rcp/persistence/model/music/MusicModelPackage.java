...
public class MusicModelPackage extends ModelPackage {
	...
	public static MusicModelPackage initialize() {
		...
		ModelResolver.getInstance().registerClassModelMapping(Artist.class, modelPackage.getArtistEClass(),
				modelPackage);
		ModelResolver.getInstance().registerClassModelMapping(Country.class, modelPackage.getCountryEClass(),
				modelPackage);
		...
		ModelResolver.getInstance().registerClassModelMapping(Rating.class, modelPackage.getRatingEEnum(),
				modelPackage);
