...
public class TexoWebExampleContextListener implements ServletContextListener {
  ...
  public void contextInitialized(ServletContextEvent arg0) {
    ...
    ServiceModelPackageRegistry.getInstance().register(ClubModelPackage.INSTANCE);
    ServiceModelPackageRegistry.getInstance().register(CompetitionModelPackage.INSTANCE);
    ServiceModelPackageRegistry.getInstance().register(TravelModelPackage.INSTANCE);

    EntityManagerProvider.getInstance().setPersistenceUnitName("texo-derby"); //$NON-NLS-1$
